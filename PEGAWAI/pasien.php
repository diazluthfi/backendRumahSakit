					...
					<div class="col s12 m12 l12">
						...
						<div class="card-action">
				            	<td colspan='9'>
				            		 ...
				            		 <th><a href="daftarpasien.php" class="grey-text text-darken-2">Daftar Pasien</a>
                         			 <i class="material-icons left grey-text text-darken-2">visibility</i></th>
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
			                    ...
			                    if ($user_data['Status']=='Blum Disetujui') {
			                    	echo "<td><a class='btn btn-info grey darken-2' href='validasi.php?id=$user_data[Antrian]' >".$user_data['Status']."</a></td>";
						...
						<table>
							<tr>
								<div class="card-action">
				            	<td colspan='9'>
								<a href='tambahpasien.php' class="right waves-effect waves-light btn grey darken-2">Tambah Pasien<i class="material-icons right">add</i></a>
							</td>
								</div>
                      		 </td>
				            </tr>
