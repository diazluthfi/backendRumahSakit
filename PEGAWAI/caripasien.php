					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $sql = "SELECT * FROM pasien WHERE Antrian LIKE '%$cari%' OR NIK LIKE '%$cari%' OR Nama LIKE '%$cari%' OR Tanggal_Lahir LIKE '%$cari%' ID_Jenis_Kelamin LIKE '%$cari%' OR Telp LIKE '%$cari%' OR Alamat LIKE '%$cari%' OR Keluhan LIKE '%$cari%'";
			                    $query = mysqli_query($koneksi,$sql);
			                      ...
			                      if($data = mysqli_fetch_array($query)){
				                	...
				                	echo "<td> <a href='edit-user.php?id=$data[Antrian]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='delete.php?id=$data[Antrian]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> | <a href='edit-password.php?id=$data[Antrian]' style='text-decoration: none;'><i class='material-icons' title='Ganti Kata Sandi $test'>lock</i></a> </td></tr>";
			                      }
			                    }
			                ?>
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='pasien.php' class="right waves-effect waves-light btn grey darken-2">KEMBALI</a>
				            	</td>
				            </tr>
						</table>
					</div>
