					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $sql = "SELECT * FROM dokter WHERE ID_Dokter LIKE '%$cari%' OR NIK LIKE '%$cari%' OR Nama LIKE '%$cari%' OR Tanggal_Lahir LIKE '%$cari%' ID_Jenis_Kelamin LIKE '%$cari%' OR Telp LIKE '%$cari%' OR Alamat LIKE '%$cari%' OR Kode_Spesialis LIKE '%$cari%'";
