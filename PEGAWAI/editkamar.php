...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE kamar SET Jenis_Kamar='$Jenis_Kamar',Harga='$Harga' WHERE No_Kamar= '$id'");
...
$result = mysqli_query($koneksi, "SELECT * FROM kamar WHERE No_Kamar='$id'");
        ...
        <form action="" method="post" name="form1">
          <div class="col s12 m12 l12 card-panel z-depth"> <br>
            <table class="highlight">
              ...
              <tr>
                    <td>No Kamar</td>
                    <th><input type="text" name="No_Kamar" value=<?php echo $No_Kamar;?> disabled></th>
                  </tr>
                  <tr> 
                    <td>Jenis Kamar</td>
