...
$kueri = mysqli_query($con, "SELECT * FROM Pegawai");
  ...
  $kueri2 = mysqli_query($con, "SELECT * FROM Dokter");
    ...
    <header>
      <!--TopNav-->
          ...
          <div class="container">
            ...
            <div class="col offset-l2 nav-wrapper">
              <a href="#" data-activates="slide-out" class="button-collapse top-nav full hide-on-large-only"><i class="material-icons">menu</i></a>
              <a href="editpassworddokter.php">Ganti password</a>
            </div>
          </div>
      </nav>
      ...
      <div class="row container">
        <div class="col s12 m12 l9 offset-l3">
          ...
          <div class="col s12 m6 l6">
                    <div class="card green-grey lighten-5">
                        ...
                        <div class="card-action">
                          <i class="material-icons left green-text text-darken-2">visibility</i>
                          <a href="Pasien.php" class="green-text text-darken-2">Lihat</a>
                        </div>
                    </div>
                  </div>
          ...
          <div class="col s12 m6 l6">
                    <div class="card green-grey lighten-5">
                        ...
                        <div class="card-action">
                          <i class="material-icons left green-text text-darken-2">visibility</i>
                          <a href="Obat.php" class="green-text text-darken-2">Lihat</a>
                        </div>
                    </div>
                  </div>
                    <!--content Gudang-->
          <div class="col s12 m6 l6">
                    <div class="card green-grey lighten-5">
                        ...
                        <div class="card-action">
                          <i class="material-icons left green-text text-darken-2">visibility</i>
                          <a href="kamar.php" class="green-text text-darken-2">Lihat</a>
                        </div>
                    </div>
                  </div>
                  <!--content Gudang-->
          <div class="col s12 m6 l6">
                    <div class="card green-grey lighten-5">
                        ...
                        <div class="card-action">
                          <i class="material-icons left green-text text-darken-2">visibility</i>
                          <a href="perawatan.php" class="green-text text-darken-2">Lihat</a>
                        </div>
                    </div>
                  </div>
                  <!--content Gudang-->
          ...
          <div class="col s12 m6 l6">
                    <div class="card green-grey lighten-5">
                        ...
                        <div class="card-action">
                          <i class="material-icons left green-text text-darken-2">visibility</i>
                          <a href="struk.php" class=green-text text-darken-2">Lihat</a>
                        </div>
                    </div>
                  </div>
              </div>
