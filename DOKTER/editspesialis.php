...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE Spesialis SET Spesialis='$Spesialis' WHERE Kode_spesialis= '$id'");
...
$result = mysqli_query($koneksi, "SELECT * FROM Spesialis WHERE Kode_Spesialis='$id'");
            ...
            <table class="highlight">
              <!--kolom isian table-->
                  ...
                  <tr> 
                    ...
                    <td><input type="text" name="Kode_Spesialis" value="<?php echo $Kode_Spesialis;?>"  disabled></td>
                  </tr>
                  <tr> 
                    <td>Spesialis</td>
                  ...
                  <table>
                    <tr>
                      <th>
                        <input type="submit" name="update" value="Edit Spesialis" class="right waves-effect waves-light btn green darken-2" style="float: left;">
                      </th>
                      <th style="width: 1%;">
