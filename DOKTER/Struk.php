...
<body>
  <div class="row">
			...
			<div class="row container">
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="caristruk.php" class="row">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
			                    $test = $user_data['ID_Struk']; 
				                echo "<tr>";
			                    echo "<td >".$user_data['ID_Struk']."</td>";
				                ...
				                echo "<td> <a href='editstruk.php?id=$user_data[ID_Struk]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deletestruk.php?id=$user_data[ID_Struk]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
				            }
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambahstruk.php' class="right waves-effect waves-light btn green darken-2">Tambah Struk<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
	...
	<script>
        ...
        var jawab = confirm("Anda Yakin Ingin Menghapus Struk ?");
        if (jawab === true) {
        // konfirmasi
            var hapus = false;
            if (!hapus) {
