					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							<!--kolom isian table-->
				              ...
				              <th>Kode Bagian</th>
				              <th><input type="text" name="Kode_Bagian" required></th>
				            
				            <tr>
				              <th>Bagian</th>
				              <th><input type="text" name="Bagian" required maxlength="50"></th>
				            </tr>
						...
						<table>
				            <tr>
				            	<th>
				            		<input type="submit" name="tambah" value="Tambah bagian" class="right waves-effect waves-light btn green darken-2" style="float: left;">
				            	</th>
				            	<th style="width: 1%;">
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            // Insert user data into table
             $result = mysqli_query($koneksi, "INSERT INTO `bagian` (`Kode_Bagian`, `Bagian`) VALUES('$Kode_Bagian','$Bagian')");
            

            if ($Kode_Bagian !=NULL)
            {
            	echo "<script>alert('Tambah Bagian Dengan Bagian $Bagian Berhasil')</script>";
         	  }
            else
            {
            	echo "<script>alert('Gagal Menambah Bagian dengan Bagian $Bagian')</script>";
            }
