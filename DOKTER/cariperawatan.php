					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $sql = "SELECT * FROM perawatan WHERE ID_Rawat LIKE '%$cari%' OR Jam LIKE '%$cari%' OR Tanggal LIKE '%$cari%' OR Antrian LIKE '%$cari%' OR ID_Pegawai LIKE '%$cari%' OR ID_Dokter LIKE '%$cari%' OR ID_Obat LIKE '%$cari%'";
			                    $query = mysqli_query($conn,$sql);
			                      ...
			                      if($query!=NULL){
			                        ...
			                        $test = $data['ID_Rawat'];
			                        echo "<tr>";
			                  		echo "<td ><h6>".$data['ID_Rawat']."</td>";
				              		echo "<td> <h6>".$data['Jam']."</h6></td>";
				               		echo "<td> <h6>".$data['Tanggal']."</h6> </td>";
				             	    echo "<td><h6>".$data['Antrian']."</h6></td>";
				                    echo "<td><h6>".$data['ID_Pegawai']."</h6></td>";
			                        echo "<td><h6>".$data['ID_Dokter']."</h6></td>";   
			                        echo "<td><h6>".$data['ID_Obat']."</h6></td>";
				                     echo "<td> <a href='editperawatan.php?id=$data[ID_Rawat]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deleteperawatan.php?id=$data[ID_Rawat]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </a> </td></tr>";
				                 }
			                      }else{
			                      	echo "<table>";
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='perawatan.php' class="right waves-effect waves-light btn green darken-2">KEMBALI</a>
				            	</td>
				            </tr>
						</table>
					</div>
