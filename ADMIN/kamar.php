			...
			<div class="row container">
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="carikamar.php" class="row">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
			                    $test = $user_data['No_Kamar']; 
				                echo "<tr>";
			                    echo "<td >".$user_data['No_Kamar']."</td>";
				                echo "<td> <h6>".$user_data['Jenis_Kamar']."</h6></td>";
			                    echo "<td><h6>".$user_data['Harga']."</h6></td>";   
				                echo "<td> <a href='editkamar.php?id=$user_data[No_Kamar]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deletekamar.php?id=$user_data[No_Kamar]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
				            }
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambahkamar.php' class="right waves-effect waves-light btn blue darken-2">Tambah Kamar<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
