...
<body>
			...
			<div class="row container">
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="caribagian.php" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Cari Berdasarkan Kode Bagian / Bagian  " class="validate" required title="Cari User">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
			                    $test = $user_data['Bagian']; 
				                echo "<tr>";
			                    echo "<td >".$user_data['Kode_Bagian']."</td>";
				                echo "<td> <h6>".$user_data['Bagian']."</h6></td>";  
				                echo "<td> <a href='editbagian.php?id=$user_data[Kode_Bagian]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deletebagian.php?id=$user_data[Kode_Bagian]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
				            }
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambahbagian.php' class="right waves-effect waves-light btn blue darken-2">Tambah Bagian<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
	...
	<script>
        ...
        // konfirmasi
            ...
            if (!hapus) {
                hapus = true;
                $.post('deletebagian.php', {id: $(this).attr('data-id')},
                function (data) {
                    alert(data);
                });
                hapus = false;
