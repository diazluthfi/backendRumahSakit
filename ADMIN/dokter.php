			...
			<div class="row container">
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="caridokter.php" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Cari Berdasarkan ID Dokter / Nama / NIK / Alamat / Spesialis " class="validate" required title="Cari Dokter">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
			                    ...
			                    echo "<td><h6>".$user_data['Kode_Spesialis']."</h6></td>";   
				                echo "<td> <a href='editdokter.php?id=$user_data[ID_Dokter]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deletedokter.php?id=$user_data[ID_Dokter]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> | <a href='editpassworddokter.php?id=$user_data[ID_Dokter]' style='text-decoration: none;'><i class='material-icons' title='Ganti Kata Sandi $test'>lock</i></a> </td></tr>";
				            }
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambahdokter.php' class="right waves-effect waves-light btn blue darken-2">Tambah User<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
