...
<body>
			...
			<div class="row container">
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="cariobat.php" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Cari Berdasarkan ID OBat / Nama Obat / Tanggal Kadaluarsa / Harga  " class="validate" required title="Cari Obat">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
			                    $test = $user_data['Nama_Obat']; 
				                echo "<tr>";
			                    echo "<td >".$user_data['ID_Obat']."</td>";
				                echo "<td> <h6>".$user_data['Nama_Obat']."</h6></td>";
				                echo "<td><h6>".$user_data['Tanggal_Kadaluarsa']."</h6></td>";

			                    echo "<td><h6>".$user_data['Harga']."</h6></td>";   
				                echo "<td> <a href='editobat.php?id=$user_data[ID_Obat]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deleteobat.php?id=$user_data[ID_Obat]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
				            }
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambahobat.php' class="right waves-effect waves-light btn blue darken-2">Tambah Obat<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
	...
	<script>
        ...
        var jawab = confirm("Anda Yakin Ingin Menghapus Obat ?");
        if (jawab === true) {
        // konfirmasi
            var hapus = false;
            if (!hapus) {
