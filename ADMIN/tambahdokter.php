					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							<!--kolom isian table-->
				              ...
				              <th>ID Dokter</th>
				              <th><input type="text" name="ID_Dokter" required></th>
				            ...
				            <tr>
				              ...
				              <th>	
				                <input type="text" name="Kode_Spesialis" required>
				              </th>
				            </tr>
				            <tr>
				              <th>Username</th>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            // Insert user data into table
             $result = mysqli_query($koneksi, "INSERT INTO `dokter` (`ID_Dokter`, `NIK`, `Nama`, `Tanggal_Lahir`, `Telp`, `ID_Jenis_Kelamin`, `Kode_Spesialis`, `username`, `password`) VALUES('$ID_Dokter','$NIK','$Nama','$Tanggal_Lahir','$Telp','$ID_Jenis_Kelamin','$Kode_Spesialis','$username','$password')");
