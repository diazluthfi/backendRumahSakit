...
<body>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Cari Berdasarkan Kode Spesialis / Spesialis  " class="validate" required title="Cari User">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $sql = "SELECT * FROM spesialis WHERE Kode_Spesialis LIKE '%$cari%' OR Spesialis LIKE '%$cari%'";
			                    $query = mysqli_query($conn,$sql);
			                      ...
			                      if($query!=NULL){
				            		...
				            		while ($data=mysqli_fetch_array($query)) {
				            			$test = $data['Spesialis'];
			                        echo "<tr>";
			                  		echo "<td ><h6>".$data['Kode_Spesialis']."</td>";
				              		echo "<td> <h6>".$data['Spesialis']."</h6></td>";			                    
				                     echo "<td> <a href='editspesialis.php?id=$data[Kode_Spesialis]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deletespesialis.php?id=$data[Kode_Spesialis]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
			                      }
			                      }else{
			                      	echo "<table>";
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='spesialis.php' class="right waves-effect waves-light btn blue darken-2">KEMBALI</a>
				            	</td>
				            </tr>
						</table>
					</div>
	...
	<script>
        ...
        // konfirmasi
            ...
            if (!hapus) {
                hapus = true;
                $.post('deletespesialis.php', {id: $(this).attr('data-id')},
                function (data) {
                    alert(data);
                });
                hapus = false;
