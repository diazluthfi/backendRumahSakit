					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $sql = "SELECT * FROM bagian WHERE Kode_Bagian LIKE '%$cari%' OR Bagian LIKE '%$cari%'";
			                    $query = mysqli_query($conn,$sql);
			                      ...
			                      if($query!=NULL){
				            		...
				            		while ($data=mysqli_fetch_array($query)) {
				            			$test = $data['Bagian'];
			                        echo "<tr>";
			                  		echo "<td ><h6>".$data['Kode_Bagian']."</td>";
				              		echo "<td> <h6>".$data['Bagian']."</h6></td>";			                    
				                     echo "<td> <a href='editbagian.php?id=$data[Kode_Bagian]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deletebagian.php?id=$data[Kode_Bagian]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
			                      }
			                      }else{
			                      	echo "<table>";
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='bagian.php' class="right waves-effect waves-light btn blue darken-2">KEMBALI</a>
				            	</td>
				            </tr>
						</table>
					</div>
