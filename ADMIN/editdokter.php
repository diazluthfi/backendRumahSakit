...
$result = mysqli_query($koneksi, "SELECT * FROM dokter ORDER BY ID_Dokter DESC");
...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE dokter SET NIK='$NIK',Nama='$Nama',Tanggal_Lahir='$Tanggal_Lahir',Telp='$Telp',ID_Jenis_Kelamin='$ID_Jenis_Kelamin',Kode_Spesialis='$Kode_Spesialis' WHERE ID_Dokter= '$id'");
...
$result = mysqli_query($koneksi, "SELECT * FROM dokter WHERE ID_Dokter='$id'");
...
while($user_data = mysqli_fetch_array($result))
{
  ...
  $Kode_Spesialis = $user_data['Kode_Spesialis'];
}
?>
				...
				<form action="" method="post" name="form1">
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
					        	<td>ID_Dokter</td>
					        	<th><input type="text" name="ID_Dokter" value=<?php echo $ID_Dokter;?> disabled></th>
					      	</tr>
					      	<tr> 
					        	<td>NIK</td>
					      	...
					      	<tr> 
					        	...
					        	<td><input type="text" name="Kode_Spesialis" value=<?php echo $Kode_Spesialis;?>></td>
					      	</tr>
					      	</table>
					      	<table>
				            <tr>
				            	...
				            	<th style="width: 1%;">
				            		<a href="dokter.php"><input type="button" value="Kembali" class="right waves-effect waves-light btn red darken-2"></a> 
				            	</th>
				            </tr>
				        </table>
					</div>
