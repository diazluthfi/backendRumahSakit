					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							<!--kolom isian table-->
				              ...
				              <th>NO Kamar</th>
				              <th><input type="text" name="No_Kamar" required></th>
				            
				            <tr>
				              <th>Jenis Kamar</th>
				              <th><input type="text" name="Jenis_Kamar" required maxlength="50"></th>
				            </tr>
						...
						<table>
				            <tr>
				            	...
				            	<th style="width: 1%;">
				            		<a href="kamar.php"><input type="button" value="Kembali" class="right waves-effect waves-light btn red darken-2"></a>
				            	</th>
				            </tr>
				        </table>
					</div>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            // Insert user data into table
             $result = mysqli_query($koneksi, "INSERT INTO `kamar` (`No_Kamar`, `Jenis_Kamar`, `Harga`) VALUES('$No_Kamar','$Jenis_Kamar','$Harga')");
            

            if ($No_Kamar !=NULL)
            {
            	echo "<script>alert('Tambah Kamar Dengan No Kamar $No_Kamar Berhasil')</script>";
         	  }
            else
            {
            	echo "<script>alert('Gagal Menambah Kamar dengan No Kamar $No_Kamar')</script>";
            }
