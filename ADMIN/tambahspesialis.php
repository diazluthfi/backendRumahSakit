					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							<!--kolom isian table-->
				              ...
				              <th><input type="text" name="Kode_Spesialis" required></th>
				            
				            <tr>
				              <th>Spesialis</th>
				              <th><input type="text" name="Spesialis" required maxlength="50"></th>
				            </tr>
						...
						<table>
				            <tr>
				            	<th>
				            		<input type="submit" name="tambah" value="Tambah Spesialis" class="right waves-effect waves-light btn green darken-2" style="float: left;">
				            	</th>
				            	<th style="width: 1%;">
				            		<a href="Spesialis.php"><input type="button" value="Kembali" class="right waves-effect waves-light btn red darken-2"></a>
				            	</th>
				            </tr>
				        </table>
					</div>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            // Insert user data into table
             $result = mysqli_query($koneksi, "INSERT INTO `Spesialis` (`Kode_Spesialis`, `Spesialis`) VALUES('$Kode_Spesialis','$Spesialis')");
            

            if ($Kode_Spesialis !=NULL)
            {
            	echo "<script>alert('Tambah Spesialis Dengan Kode Spesialis $Kode_Spesialis Berhasil')</script>";
         	  }
            else
            {
            	echo "<script>alert('Gagal Menambah Spesialis dengan Kode Spesialis $Kode_Spesialis')</script>";
            }
