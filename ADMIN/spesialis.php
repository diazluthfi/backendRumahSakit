...
$result = mysqli_query($koneksi, "SELECT * FROM spesialis ORDER BY Kode_Spesialis DESC");
			...
			<div class="row container">
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="carispesialis.php" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Cari Berdasarkan Kode Spseialis / Spesialis  " class="validate" required title="Cari User">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
			                    $test = $user_data['Spesialis']; 
				                echo "<tr>";
			                    echo "<td >".$user_data['Kode_Spesialis']."</td>";
				                echo "<td> <h6>".$user_data['Spesialis']."</h6></td>";  
				                echo "<td> <a href='editspesialis.php?id=$user_data[Kode_Spesialis]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='deletespesialis.php?id=$user_data[Kode_Spesialis]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
				            }
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambahspesialis.php' class="right waves-effect waves-light btn blue darken-2">Tambah Spesialis<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
