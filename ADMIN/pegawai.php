			...
			<div class="row container">
				<div class="col s12 m12 l12 offset-l2"> <br>
					...
					<div class="col s12 m12 l12">
						<form name="cari" method="post" action="caripegawai.php" class="row">
	                    	<div class="e-input-field col s12 m12 l12">
	                    		<input type="text" name="cari" placeholder="Cari Berdasarkan ID Pegawai / NIK / Nama / Dll  " class="validate" required title="Cari User">
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							while($user_data = mysqli_fetch_array($result)) { 
				                ...
				                echo "<td><h6>".$user_data['Telp']."</h6></td>";
				                echo "<td><h6>".$user_data['ID_Jenis_Kelamin']."</h6></td>";
			                    echo "<td><h6>".$user_data['Kode_Bagian']."</h6></td>";   
				                echo "<td> <a href='editpegawai.php?id=$user_data[ID_Pegawai]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> | <a data-id='1' class='hapus' href='delete.php?id=$user_data[ID_Pegawai]' style='text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> | <a href='editpassword.php?id=$user_data[ID_Pegawai]' style='text-decoration: none;'><i class='material-icons' title='Ganti Kata Sandi $test'>lock</i></a> </td></tr>";
				            }
						...
						<table>
							<tr>
				            	<td colspan='9'>
				            		<a href='tambahpegawai.php' class="right waves-effect waves-light btn blue darken-2">Tambah Pegawai<i class="material-icons right">add</i></a>
				            	</td>
				            </tr>
						</table>
					</div>
